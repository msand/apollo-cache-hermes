...
export function map(callback, context) {
  return entryPoints.map(callback, context);
}

export function check(id, parentId) {
...
export function getEntryPointDirectory(file) {
...
export function buildDocEntryPoints(context) {

...
import { DataProps, OperationOption, OptionProps } from '@apollo/client/react/hoc';
...
>(
  ...
  if (typeof mapPropsToOptions !== 'function') mapPropsToOptions = () => options as BaseQueryOptions;

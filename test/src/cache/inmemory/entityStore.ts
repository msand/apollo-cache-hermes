...
import { Modifier, Modifiers, NormalizedCache } from '@apollo/client/cache';
...
class Layer extends EntityStore {
  ...
  public getStorage(idOrObj: string | StoreObject, ...storeFieldNames: (string | number)[]): StorageType {
